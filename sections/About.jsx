                    ...
                    >
                        <div className="flex flex-col gap-5 text-secondary-text text-[16px] mb-[50px]">
                            <p>
                                ...
                                Full-Stack developer, tackling various web
                                projects. I've had the privilege to be a part of
                                more than <strong>50 Projects </strong>,
                                collaborating with startups, agencies, and
                                talented individuals.
                            </p>
                            <p>
                                My journey in web development has been filled
                                with Challenges, but I approach them with quiet
                                confidence and a never-ending desire to learn.
                                I've been working on both the{" "}
                                <strong>Front-End</strong>, using tools like
                                React / Next, and the <strong>Back-End</strong>{" "}
                                with Node.js, to create dynamic web
                                applications.
                            </p>
                        </div>

        ...
        >
            <SwiperSlide className="slider-container">
                <div className="client-profile flex gap-3 items-center mb-[35px]">
                    ...
                    <div className="flex flex-col justify-start">
                        <h6 className="text-[1.2rem]">Tym Mills</h6>
                        <p className="text-[0.9rem] text-secondary-text">
                            CEO of{" "}
            ...
            <SwiperSlide className="slider-container">
                <div className="client-profile flex gap-3 items-center mb-[35px]">
                    ...
                    />
                    <div className="flex flex-col justify-start">
                        <h6 className="text-[1.2rem]">Ema Grace</h6>
                        <p className="text-[0.9rem] text-secondary-text">
                            Product Manager of{" "}
            ...
            <SwiperSlide className="slider-container">
                <div className="client-profile flex gap-3 items-center mb-[35px]">
                    ...
                    />
                    <div className="flex flex-col justify-start">
                        <h6 className="text-[1.2rem]">James Wagner</h6>
                        <p className="text-[0.9rem] text-secondary-text">
                            Founder & CEO of{" "}
            ...
            <SwiperSlide className="slider-container">
                <div className="client-profile flex gap-3 items-center mb-[35px]">
                    ...
                    />
                    <div className="flex flex-col justify-start">
                        <h6 className="text-[1.2rem]">Kate Ramsey</h6>
                        <p className="text-[0.9rem] text-secondary-text">
                            Founder of{" "}
                            <span className="text-secondary">
                                Kate Industry
